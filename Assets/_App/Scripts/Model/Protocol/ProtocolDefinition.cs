...
public class ProtocolDefinition
{
    ...
    public int Version { get; set; } // Version to help identify differences in file formats
...
public class ArObject
{
    ...
    public string SpecificObjectName { get; set; } // Unique name to be displayed, e.g., "WellPlate 1"

    [JsonProperty("ArObjectID")]
    public string ArObjectID { get; set; } // Unique identifier, e.g., "centrifuge_001"

    [JsonProperty("RootPrefabName")]
    public string RootPrefabName { get; set; } // e.g., "wellplate", "reservoir", "miltenyimachine"
}
