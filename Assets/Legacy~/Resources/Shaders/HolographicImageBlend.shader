...
// https://forum.unity.com/threads/holographic-photo-blending-with-photocapture.416023/
//See LocatableCameraShader.shad https://github.com/microsoft/OpenXR-Unity-MixedReality-Samples
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed4 finalColor = tex2D(_MainTex, uv); //fixed4(uv.xy, 0, 1.0);//
