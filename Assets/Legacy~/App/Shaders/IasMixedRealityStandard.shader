...
#define PROXIMITY_LIGHT_DATA_SIZE 6
            ...
            // Texturing.
                ...
                // IAS MACHINE - modified
                // albedo.rgba = lerp(albedo.rgba, borderContribution, borderValue);
                albedo.rgb = lerp(albedo.rgb, borderContribution, borderValue);
                albedo.a = lerp(albedo.a, _HoverColorOverride.a, borderValue);
#else
