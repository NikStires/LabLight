...
public class ArObjectManager : MonoBehaviour
{
    ...
    public MaskAndTitleViewController MaskAndTitlePrefab;
    public BoundingBoxViewController BoundingBoxPrefab;
    public OutlineElementViewController OutlinePrefab;
    public OverlayElementViewController OverlayPrefab;
    ...
    {
        charucoTransform = SessionManager.Instance.CharucoTransform;
    ...
    private void SpecificArDefinitionAdded(ArDefinition arDefinition)
    {
        ...
        switch (arDefinition.arDefinitionType)
        {
            ...
            case ArDefinitionType.Container:
                ...
                break;
            case ArDefinitionType.Arrow:
                //createArrow((ArrowArDefinition)arDefinition, charucoTransform); not handled
                break;
        }
    }
    ...
    private void createModel(ModelArDefinition modelArDefinition, TrackedObject trackedObject = null)
    {
        ...
        ServiceRegistry.GetService<IMediaProvider>().GetPrefab(prefabPath).Subscribe(prefab =>
        {
            ...
            if (arViewPrefab)
            {
                var prefabInstance = Instantiate(arViewPrefab, charucoTransform);
    ...
    {
        ContainerElementViewController viewController = Instantiate((arDefinition.layout.layoutType == LayoutType.Vertical) ? WorldContainerVertical : WorldContainerHorizontal, charucoTransform);
